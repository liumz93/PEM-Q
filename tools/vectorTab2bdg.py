...
fout.close()
####!!!!here!!!!!####
os.system('bedtools genomecov -bga -i %s -g vector/%s.genome >> %s' % (bedsort, vector_fa_index, bedgraphname))
...
fout.close()
####!!!!here!!!!!####
os.system('bedtools genomecov -strand + -bga -i %s -g vector/%s.genome >> %s' % (bedsort, vector_fa_index, bedgraphname_pos))
...
fout.close()
####!!!!here!!!!!####
os.system('bedtools genomecov -strand - -bga -i %s -g vector/%s.genome >> %s' % (bedsort, vector_fa_index, bedgraphname_neg_tmp))
